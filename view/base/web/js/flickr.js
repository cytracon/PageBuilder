define([
    'jquery',
    'Cytracon_PageBuilder/js/flickr-jquery',
    'Cytracon_PageBuilder/vendor/imagesloaded/imagesloaded.pkgd.min',
    'Cytracon_PageBuilder/vendor/blueimp/js/blueimp-gallery',
    'Cytracon_PageBuilder/vendor/blueimp/js/blueimp-gallery-fullscreen',
    'Cytracon_PageBuilder/vendor/blueimp/js/blueimp-gallery-indicator',
    'Cytracon_PageBuilder/vendor/blueimp/js/blueimp-gallery-video',
    'Cytracon_PageBuilder/vendor/blueimp/js/blueimp-gallery-vimeo',
    'Cytracon_PageBuilder/vendor/blueimp/js/blueimp-gallery-youtube',
