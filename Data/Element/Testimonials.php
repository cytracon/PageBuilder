...
class Testimonials extends \Cytracon\Builder\Data\Element\AbstractElement
{
    /**
        ...
        return [
            ...
            'items'       => [
                [
                    ...
                    'content' => 'For months i tried many demo\'s out their from different vendors, but at the end i found that cytracon is the best. The pagebuilder extensions comes preloaded with every thing, you dont need to buy addons for it such as elements as other builders does. Just pay one time and you get everything :)'
                ],
                [
                    'name'    => 'David',
                    'job'     => 'Designer',
                ...
                [
                    ...
                    'content' => 'We love Cytracon Page Builder, it makes Magento site development so easy. We don’t have the time to spend tweaking our site, we are just too busy. Cytracon Page Builder lets any of our team members log in and make changes without having a lot of coding knowledge.'
                ]
            ]
        ];
    }
